          ...
          <div className="grid md:grid-cols-3 grid-cols-1 w-full md:gap-5">
            ...
            ${selectedImage === item ? "border border-black" : ""}`}
              ...
              {productsId.category_type === "Products" && (
                <div>
                  <p className="text-custom-newBlacks text-sm	font-semibold md:pt-10 pt-5">
                    {t("Long Description")}
                  </p>
                  <p className="text-custom-newBlacks text-sm	font-normal md:pt-5 pt-3">
              ...
              {!productsId?.categoryName && (
                <div className="pt-5 border-b border-b-custom-newOffWhite pb-5">
                  <p className="text-custom-newBlacks text-xl font-bold">
                    {t("Key attributes")}
                  </p>

                  <div className="pt-5">
                    {productsId?.attributes?.map((item, i) => (
                      <div
                        key={i}
                        className="w-full border border-custom-newOffWhite  grid md:grid-cols-2 grid-cols-1"
                      >
                        <div className="bg-custom-offWhiteColor flex justify-start items-center md:px-5 px-3 border-r border-r-custom-newOffWhite">
                          <p className="text-custom-newBlacks font-normal md:text-base text-xs">
                            {item?.name}
                          </p>
                        </div>
                        <div className="bg-white flex justify-start items-center md:px-5 px-3 py-1">
                          <p className="text-custom-newBlacks font-medium md:text-base text-xs">
                            {item?.value}
                          </p>
                        </div>
                      </div>
            ...
            {productsId.category_type === "Products" && (
              <div className="bg-white rounded-[8px] pt-5 md:pb-5 md:px-5 md:h-[650px]">
                <div className="flex justify-between items-center md:pb-5 pb-3 border-b border-b-custom-newOffWhite">
                  ...
                  <div
                    className="w-[46px] h-[46px] bg-custom-grayColorNew rounded-full flex justify-center items-center"
                ...
                <div className="md:pt-5 pt-3 md:pb-5 pb-3 border-b border-b-custom-newOffWhite">
                  <p className="text-custom-newBlacks font-semibold text-lg">
                    {t("Quantity")}
                  </p>
                  <div className="border border-custom-newOffWhite max-w-max h-[30px] rounded-[15px] md:mt-5 mt-3 flex items-center">
                    <div
                      className="h-[30px] w-[30px] bg-custom-newLightGrays rounded-[15px] flex justify-center items-center cursor-pointer"
                      onClick={() => {
                        if (productsId.qty > 1) {
                    ...
                    <p className="text-custom-newDarkBlack text-base font-normal text-center mx-4">
                      {productsId?.qty || 0}
                    </p>
                    <div
                      className="h-[30px] w-[30px] bg-white border border-custom-newOffWhite rounded-[15px] flex justify-center items-center cursor-pointer"
                      onClick={() => {
                        productsId.qty = productsId.qty + 1;
                        productsId.total = (
                          productsId?.price * productsId.qty
                          ...
                          <div className="w-full">
                            ...
                            <div className="w-full">
                              {/* <input className="bg-white w-full md:h-[50px] h-[40px] px-5 rounded-[10px] border border-custom-newGray font-normal  text-base text-black outline-none mb-5" type="text" placeholder={t("Country")}
                                                ...
                                                /> */}
                              <Select
                                className="md:!min-h-[50px] min-h-[40px] mb-5"
                                placeholder="Country"
                                options={options}
                                value={shippingAddressData?.country}
                                required
                ...
                <div className="pt-5">
                  <div className="flex justify-between items-center">
                    <p className="text-custom-newBlacks md:text-base text-sm font-normal">
                      {t("Item subtotal")}
                    </p>
                    <p className="text-custom-newBlacks text-sm font-normal">
                      {constant?.currency}
                      {productsId.total}
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between items-center pt-2">
                    <p className="text-custom-newBlacks md:text-base text-sm font-semibold">
                      {t("Subtotal")}
                    </p>
                    <p className="text-custom-newBlacks text-sm font-semibold">
                      {constant?.currency}
                      {productsId.total}
                    </p>
                  </div>
                ...
                <div className="flex gap-5 mt-5">
                  {user?.token && (
                    <button
                      className="bg-custom-newDarkBlack w-full md:h-[50px] h-[40px] rounded-[24px] text-white font-semibold text-sm"
                      onClick={() => {
                        // if (cartData?.length === 0) {
                        //     props.toaster({ type: "warning", message: 'Your cart is empty' });
                        //     return
                  ...
                  <button
                    className="border border-custom-newDarkBlack w-full md:h-[50px] h-[40px] rounded-[24px] text-custom-blackColor font-semibold text-sm"
                    onClick={() => {
                      const d = cartData?.length > 0 ? cartData : [];
                      const c = d.find(
                        (f) =>
                          f._id === productsId?._id &&
                          f?.selectedColor?.color === selectedColor?.color,
                      );
                      if (!c) {
                        // console.log(d)
                        // if (selectedColor) {
                        ...
                        const nextState = produce(cartData, (draft) => {
                          let index = draft.find(
                            (f) => f._id === productsId._id,
                          );
                      ...
                      props.toaster({
                        type: "success",
                        message: `${productsId.qty} item(s) added to the cart`,
                      });
                      productsId.qty = 1;
                      setProductsId({ ...productsId });
                      // router.push('/cart')
                ...
                <p className="text-custom-newBlacks text-sm	font-semibold md:pt-5 pt-3">
                  {t("Short Description")}
                </p>
                <p className="text-custom-newBlacks text-sm	font-normal md:pt-5 pt-3">
            ...
            {productsId.category_type === "Business" && (
              <div className="bg-white rounded-[8px] boxShadow p-5 md:mt-0 mt-5">
                <div className="flex justify-between items-center md:pb-5 pb-3 border-b border-b-custom-newOffWhite">
                  {productsId.category_type === "Products" && (
                    <div>
                      <p className="text-custom-blackColor md:text-xl text-base font-bold">
                ...
                <div className="md:pt-5 pt-3 ">
                  ...
                  <div className="md:pt-5 pt-3 flex justify-start items-center md:gap-5 gap-2">
                    {productsId?.attributes?.map((item, i) => (
                      <button
                        key={i}
                        className={`w-[111px] md:h-[48px] h-[40px] rounded-[24px]  md:text-sm text-[10px] font-semibold text-center ${selectedName?.name === item?.name ? "bg-black border border-custom-newBlacks  text-white" : "bg-white border border-custom-newBlacks  text-custom-blackColor"}`}
                        onClick={() => {
                  ...
                  <button
                    className="bg-black w-[182px] md:h-[48px] h-[40px] rounded-[24px] text-white text-sm font-semibold text-center md:mt-5 mt-3"
                    onClick={() => {
                      if (!selectedName?.name) {
                        props.toaster({
                          type: "success",
                          message: "Selected name is required",
                        });
                        return;
                      } else {
                        setShowDate(true);
              ...
              <div className="fixed top-0 left-0 w-screen h-screen bg-black/30 flex justify-center items-center z-50">
                <div className="relative w-[300px] md:w-[360px] h-auto  bg-white rounded-[15px] m-auto">
                  ...
                  <div className="px-5 py-5">
                    ...
                    <div className="w-full">
                      <p className="text-black font-normal text-base pb-2">
                        {t("Start Date")}
                      </p>
                      <input
                        className="outline-none border-2 border-black md:p-2 p-1 rounded text-black w-full"
                        type="datetime-local"
                        value={dateObj.start_date}
                        onChange={(text) => {
                          console.log(text);
                          setDateObj({
                            ...dateObj,
                            start_date: text.target.value,
                          });
                    ...
                    {selectedName?.name !== "Half-Day" &&
                      selectedName?.name !== "Full-Day" && (
                        <div className="w-full  mt-5">
                          ...
                          <input
                            className="outline-none border-2 border-black md:p-2 p-1 rounded text-black w-full"
                            type="datetime-local"
                            value={dateObj.end_date}
                            onChange={(text) => {
                              console.log(text.target.value);
                              setDateObj({
                                ...dateObj,
                                end_date: text.target.value,
                              });
                            }}
                    ...
                    {selectedName?.name === "Long-Term" &&
                      productsId?.category?.name !== "Car Rental" && (
                        <div className="md:pt-5 pt-3">
                          <p className="text-custom-newBlacks font-semibold text-lg">
                            {t("How many rooms?")}
                          </p>
                            ...
                            <div
                              ...
                              onClick={() => {
                                if (productsId.rooms > 1) {
                                  ...
                                  productsId.total = (
                                    selectedName?.value * productsId.rooms
                                  ).toFixed(2);
                                  setProductsId({ ...productsId });
                                }
                              }}
          ...
          {productList?.length > 0 && (
            <>
              <div className="bg-white w-full  mt-5">
                <p className="text-custom-newDarkBlack md:text-xl text-xl font-bold text-start  pb-5">
                  {t("Realted Item")}
                </p>
